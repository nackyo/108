...
$config['sysmgr_css_path'] = 'assets/sysmgr/css/';
$config['sysmgr_js_path'] = 'assets/sysmgr/js/';
$config['sysmgr_img_path'] = 'assets/sysmgr/images/';
$config['mobile_css_path'] = 'assets/mobile/css/';
$config['mobile_js_path'] = 'assets/mobile/js/';
$config['mobile_img_path'] = 'assets/mobile/images/';
$config['epaper_css_path'] = 'assets/epaper/css/';
$config['epaper_js_path'] = 'assets/epaper/js/';
$config['epaper_img_path'] = 'assets/epaper/images/';
